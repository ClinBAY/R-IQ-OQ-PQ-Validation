...
![Diagram](./assets/img/iopqualr-how-it-works.png)
...
The function below generates a report on installation, operational and performance qualification assessment in PDF format. It takes the specifications file directory and the specification file as pre-defined arguments.
